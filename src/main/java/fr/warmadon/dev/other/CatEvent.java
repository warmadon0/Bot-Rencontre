...
@CommandInfo(
    name = {"cat", "cat"},
    description = "J'aime Les Chats. Toi Aussi? Tape Cette Commande !"
)
public class CatEvent extends Command {

    public CatEvent()
    {
        this.name = "cat";
        this.help = "J'aime Les Chats. Toi Aussi? Tape Cette Commande !";
			...
			try {
				while (null != (str = br.readLine())) {
			        ...
			        EmbedBuilder ebuilder = new EmbedBuilder()
			        		.setTitle(":cat: ● Miaou ! Oh un chat", event.getGuild().getIconUrl())
