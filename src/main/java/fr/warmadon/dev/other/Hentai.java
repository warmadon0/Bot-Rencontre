...
@CommandInfo(
    name = {"hentai", "hentais"},
    description = "J'aime les hentai. Toi Aussi? Tape Cette Commande !"
)
public class Hentai extends Command {
    ...
    {
        this.name = "hentai";
        this.help = "J'aime les hentai. Toi Aussi? Tape Cette Commande !";
        this.guildOnly = false;
        this.aliases = new String[]{"hentais"};
    }
    ...
    protected void execute(CommandEvent event) {
		...
		try {
			url = new URL("https://nekobot.xyz/api/image?type=hentai");
		...
		String str= null;
			try {
				while (null != (str = br.readLine())) {
					...
					String finalstring = json.getString("message");
					System.out.println(finalstring);
					
			        EmbedBuilder ebuilder = new EmbedBuilder()
			        		.setTitle(" Vive les hentai !", event.getGuild().getIconUrl())
