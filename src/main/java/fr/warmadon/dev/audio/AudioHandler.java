...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            mb.append(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **Je joue désormais dans : "+guild.getSelfMember().getVoiceState().getChannel().getName()+"...**"));
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                .setContent(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **En cour de lecture ...**"))
                .setEmbed(new EmbedBuilder()
                .setTitle("Aucune musique en cour de lecture")
    ...
    public String getTopicFormat(JDA jda)
    {
        ...
        else return "Aucune musique en cour de lecture " + JMusicBot.STOP_EMOJI + " " + FormatUtil.volumeIcon(audioPlayer.getVolume());
    }
